...
<?php include ('session.php');?>
	...
	<div id="header">
		<div class="head-view">
			<ul>
				<li><a href="home.php" title="ChitChat"><b>ChitChat</b></a></li>
				<li></li>
				<li></li>
				<li></li>
				<li></li>
	...
	<div>
			<form method="post" action="post.php" enctype="multipart/form-data">
				<textarea placeholder="Type in your thoughts!" name="content" class="post-text" required></textarea>
				<input type="file" name="image">
				<button class="btn-share" name="Share" value="Share">Share</button>
			</form>
	</div>
